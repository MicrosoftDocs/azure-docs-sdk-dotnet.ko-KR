...
다음 표에서는 Azure에서 컨테이너에 .NET 애플리케이션을 배포하는 방법에 대한 자세한 설명이 있는 자습서에 대한 링크를 제공합니다.
...
| [컨테이너에서 .NET 앱 배포][4] | Visual Studio 2017을 사용하여 Windows 컨테이너에 기존 ASP.NET 애플리케이션을 배포합니다.  |
